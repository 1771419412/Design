...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private int mStartToolbarPosition;//Toolbar的起始位置
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child, View dependency) {
        ...
        clp.width = (int) (mStartHeight - heightToSubtract);
        clp.height = (int) (mStartHeight - heightToSubtract);
                    ...
                    if (mFinalHeight == 0) {
                        ...
                        if (mStartXPosition == 0) {
                            ...
                            if (mFinalXPosition == 0) {
                                mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.image_final_width) + (mFinalHeight / 2);

                                //Toolbar的起始位置
                                if (mStartToolbarPosition == 0) {
                                    mStartToolbarPosition = (int) (dependency.getY() + (dependency.getHeight() / 2));
                                }
                            }
